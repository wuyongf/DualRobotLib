...
namespace DualRobotLib
{
    public class Core
    {
        ...
        public void Scene1B(MovementType movement_type)
        {
            ...
            for (int i = 0; i < via_orbit_points_part2_no; i++)
            {
                ...
                for (int j = 0; j < via_orbit_points_part1_no; j++)
                {
                    ...
                    robot_Motion_ViaPoints(drCR15, ref tfCR15, ref movement_type);
                }
        ...
        private void robot_Motion_ViaPoints(DualRobot dr, ref Transformation tf, ref MovementType movement_type)
        {
            if (this.SysIsEStop()) return;
            ...
            for (int i = 0; i < via_points_no; i++)
            {
                ...
                var dis = this.GetTcpDistance(SceneName.None, Model.CR15, Model.LiftTable);
        ...
        /// <summary>
        /// Get Tcp Distance for Scene2.
        /// </summary>
        /// <remarks>
        /// Prerequisite: Finish (1) RobotBase Calibration (2) Set StationAntennaTCP_Cr7
        /// </remarks>
        /// <returns></returns>
